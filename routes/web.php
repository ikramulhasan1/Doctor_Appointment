...
Route::get('/updatedoctor/{id}', [AdminController::class, 'updatedoctor'])->name('admin.updatedoctor');
Route::post('/editdoctor/{id}', [AdminController::class, 'editdoctor'])->name('admin.editdoctor');